...
import { ShoppingCart, Menu, X, ChevronRight, Mail, 
  Smartphone, Laptop, Watch, Headphones, 
  MonitorSmartphone, Cpu, Shield, Zap } from 'lucide-react';
    ...
    <div className="container mx-auto px-4 py-20">
      <div className="flex flex-col md:flex-row items-center gap-12">
        <div className="flex-1 text-center md:text-left">
          ...
          Transforma tu
            <span className="bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent"> Experiencia Digital</span>
          </h1>
          <p className="text-lg text-gray-600 mb-8 max-w-xl">
          Descubre productos tecnológicos de primera calidad que combinan innovación con elegancia.
          Vive el futuro del estilo de vida digital hoy.
          </p>
  ...
  const features = [
    {
      ...
      description: 'Conecta sin problemas todos tus dispositivos en un ecosistema unificado',
      icon: <MonitorSmartphone className="w-8 h-8 text-purple-600" />
    },
    {
      title: 'Diseño Premium',
      description: 'Fabricado por expertos con materiales de primera calidad y atención al detalle',
      icon: <Shield className="w-8 h-8 text-purple-600" />
    },
    {
      title: 'Rendimiento avanzado',
      description: 'Potente tecnología que se adapta a sus necesidades y estilo de vida',
    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl text-gray-400 font-bold mb-4">Por qué elegir Tienda Virtual</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
          Experimente una tecnología diseñada para mejorar su vida con funciones innovadoras y una calidad inigualable.
          </p>
        </div>
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              ...
              <h3 className="text-xl text-gray-400 font-semibold mb-3">{feature.title}</h3>
  ...
  <section className="py-20 bg-gradient-to-br from-purple-900 to-blue-900">
    <div className="container mx-auto px-4">
      <div className="max-w-2xl mx-auto text-center">
        ...
        Suscríbase a nuestro boletín para recibir ofertas exclusivas, acceso anticipado a nuevos productos y opiniones de expertos en tecnología.
        </p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
        <div>
          ...
          <ul className="space-y-2">
            {['Novedades', 'Los más vendidos', 'Destacados', 'Accesorios'].map((item) => (
              <li key={item}>
        ...
        <div>
          ...
          <ul className="space-y-2">
            {['Quiénes somos', 'Carreras profesionales', 'Press', 'Socios'].map((item) => (
              <li key={item}>
                <Link href="#" className="hover:text-purple-400 transition-colors">
                  {item}
                </Link>
        ...
        <div>
          ...
          <ul className="space-y-2">
            {['Centro de ayuda', 'Contacto con nosotros', 'Devoluciones', 'Garantía'].map((item) => (
              <li key={item}>
                <Link href="#" className="hover:text-purple-400 transition-colors">
                  {item}
                </Link>
        ...
        <div>
          ...
          <ul className="space-y-2">
            {['Política de privacidad', 'Condiciones de uso', 'Política de cookies', 'Conformidad'].map((item) => (
              <li key={item}>
                <Link href="#" className="hover:text-purple-400 transition-colors">
                  {item}
                </Link>
