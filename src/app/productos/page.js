...
import { Search, SlidersHorizontal, X, ChevronDown, Star, ShoppingCart, Heart } from 'lucide-react';
            ...
            <div className="flex flex-col md:flex-row gap-8">
                ...
                <div className="bg-white rounded-2xl shadow-sm p-6 sticky top-4">
                  ...
                  <div className="mb-8">
                    ...
                    <div className="space-y-3">
                      {['Todos', 'Smartphones', 'Laptops', 'Tablets', 'Wearables', 'Accesorios'].map((category) => (
              ...
              <div className="flex-1">
                ...
                <div className="flex justify-between items-center mb-8">
                  <p className="text-gray-700">Mostrando 24 productos</p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  {Array(9).fill(null).map((_, index) => (
                    <div key={index} className="bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow p-4">
                      {/* Product Image */}
                      ...
                      {/* Product Info */}
                      <div>
                        <h3 className="font-semibold text-lg mb-2 text-gray-800">Producto Example {index + 1}</h3>
                        ...
                        <div className="flex items-center justify-between">
                          <p className="text-xl font-bold text-purple-600">$299.99</p>
